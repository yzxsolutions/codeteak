      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          <motion.div
            ...
            <h3 className="text-4xl font-bold text-black font-wave tracking-wide">
              {testimonials[active].name}
            </h3>
            <p className="text-sm text-gray-500 dark:text-red-500">
              {testimonials[active].designation}
            </p>
            <motion.p className="mt-8 text-lg text-gray-500 dark:text-neutral-900">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-gray-100 dark:bg-red-600">
              <IconArrowLeft
